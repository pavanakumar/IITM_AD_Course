...
# ╔═╡ ea382cfc-3a0b-11ef-2d7e-a32674dcf480
begin
...
begin
	...
	plot(x,y,foo,st=:surface, colormap=:berlin, camera=[30, 40])
end

# ╔═╡ 1ac0691c-cbb4-4a38-a9f0-0243efb5dfd3
md"""
...
begin
	...
	prob = Optimization.OptimizationProblem(f, x0, param, lb = [-2.0, -2.0], ub = [2.0, 2.0])
	sol = solve(prob, Evolutionary.CMAES(μ = 40, λ = 100), abstol=1e-4)
	print("Total number of function evals = ", sol.stats.fevals, "\n")
	print("Time taken = ", sol.stats.time, " s\n")
	print("x[1] = ", sol[1], "\n")
	print("x[2] = ", sol[2], "\n")
end
...
begin
	f1 = OptimizationFunction(rosenbrock, AutoForwardDiff())
	prob1 = Optimization.OptimizationProblem(f1, x0, param, lb = [-2.0, -2.0], ub = [2.0, 2.0])
	sol1 = solve(prob1, Optimization.LBFGS(), maxiters = 100, reltol=1e-3)
	print("Total number of function evals = ", sol1.stats.fevals, "\n")
	print("Time taken = ", sol1.stats.time, " s\n")
	print("x[1] = ", sol1[1], "\n")
	print("x[2] = ", sol1[2], "\n")
end
...
ForwardDiff = "~0.10.36"
Optimization = "~3.26.3"
OptimizationEvolutionary = "~0.3.0"
Plots = "~1.40.4"
"""
...
manifest_format = "2.0"
project_hash = "e459fecdf8a5151f2e1550b6266ec92cfa7540bf"
...
git-tree-sha1 = "f64c1b91e130edb954ab86402372990280684f90"
