...
& xout3, xout3b) BIND(c, name='Encoder_2_b')
  ...
  x2b = 0.0_4
  x3b = 0.0_4
!$BWD-OF II-LOOP acc parallel loop gang vector present(edgelist, params, x, xout3) private(xin, x1, x2, x3, xout, x1_noact, x2_no
!act, x3_noact, xout_noact, x1_act, x2_act, x3_act, xout_act)
  DO inode=1,nnodes
!$FWD-OF II-LOOP acc loop seq
...
&               11), xin, xinb, x1_noact, x1_noactb)
  END DO
!$BWD-OF II-LOOP acc parallel loop collapse(2) present(xout3)
  DO inode=1,nnodes
    DO i=1,1,-1
      xout3b(i, inode) = 0.0_4
    END DO
